<%--
 ...
 @version $Id: //application/DCS-CSR-UI/version/11.2/src/web-apps/DCS-CSR-UI/panels/customer/purchasedItemsDataModel.jsp#1 $
...

{
  ...
  "results":[<c:forEach var="commerceItem" items="${formHandler.searchResults}" varStatus="status"
    >${status.index > 0 ? ',' : ''}
    {
...
<%-- @version $Id: //application/DCS-CSR-UI/version/11.2/src/web-apps/DCS-CSR-UI/panels/customer/purchasedItemsDataModel.jsp#1 $$Change: 946917 $--%>
