<%--
 ...
 @version $Id: //application/DCS-CSR-UI/version/11.2/src/web-apps/DCS-CSR-UI/panels/ordersummary/appeasement/appeasementComplete.jsp#1 $
...
<dsp:page xml="true">
  <dsp:layeredBundle basename="atg.commerce.csr.order.WebAppResources">
    ...
    <dt>
      <fmt:message key="orderSummary.appeasementComplete"/>
    </dt>
    <dd>
      &nbsp
    </dd>
...
<%-- @version $Id: //application/DCS-CSR-UI/version/11.2/src/web-apps/DCS-CSR-UI/panels/ordersummary/appeasement/appeasementComplete.jsp#1 $$Change: 1179550 $--%>
