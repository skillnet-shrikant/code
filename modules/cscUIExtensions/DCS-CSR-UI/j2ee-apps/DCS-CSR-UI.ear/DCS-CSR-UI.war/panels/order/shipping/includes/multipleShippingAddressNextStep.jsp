...
This page fragment is used in the multiple shipping address page.
...
<dsp:page xml="true">
  ...
  <dsp:input name="successURL" value="${successURL}" type="hidden"
             bean="ShippingGroupFormHandler.multipleShippingGroupCheckoutSuccessURL"/>
...
<%-- @version $Id: //application/DCS-CSR-UI/version/11.2/src/web-apps/DCS-CSR-UI/panels/order/shipping/includes/multipleShippingAddressNextStep.jsp#1 $$Change: 946917 $--%>
