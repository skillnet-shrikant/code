  ...
  <dsp:layeredBundle basename="atg.commerce.csr.order.appeasement.WebAppResources">
    ...
    <table>
      ...
      <tr>
        ...
        <csr:formatNumber value="${appeasementAmount}" type="currency" currencyCode="${currencyCode}" var="formattedAppeasementAmount"/>
        <td>
      ...
      <tr>
        <td valign="top"><b><fmt:message key="email.appeasement.approval.approved.paymentHeader"/></b></td>
        <td></td>
      </tr>
...
<%-- @version $Id: //application/DCS-CSR-UI/version/11.2/src/web-apps/DCS-CSR-UI/panels/order/confirm/emails/AppeasementApprovalAccepted.jsp#1 $$Change: 1179550 $--%>