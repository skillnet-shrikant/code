...
<fmt:message key="confirmOrder.emails.scheduledOrderUpdate.orderIsComplete" var="orderIsCompleteMessage"/>
...
<fmt:message key="confirmOrder.emails.scheduledOrderUpdate.dearCustomer">
  <fmt:param value="${fn:escapeXml(profileFirstName)}"/>
  <fmt:param value="${fn:escapeXml(profileLastName)}"/>
</fmt:message>

<p><fmt:message key="confirmOrder.emails.scheduledOrderUpdate.orderProcessed"/>

<p>
<dsp:getvalueof param="order.id" var="orderIdVar"><fmt:message key="confirmOrder.emails.scheduledOrderUpdate.contactCustomerCervice"/></dsp:getvalueof>
<fmt:message key="confirmOrder.emails.scheduledOrderUpdate.confirmationNumberIs">
...
<fmt:message key="confirmOrder.emails.scheduledOrderUpdate.orderItemIs">
  <fmt:param value="${scheduledOrderItemVar}"/>
</fmt:message>
<dsp:getvalueof param="confirmationInfo.extraData.schedule" var="scheduleVar"/>
<fmt:message key="confirmOrder.emails.scheduledOrderUpdate.scheduleIs">
  <fmt:param value="${scheduleVar}"/>
</fmt:message>
</dsp:layeredBundle>

</dsp:page>
<%-- @version $Id: //application/DCS-CSR-UI/version/11.2/src/web-apps/DCS-CSR-UI/panels/order/confirm/emails/ScheduledOrderUpdate.jsp#1 $$Change: 946917 $--%>
