  ...
  <dsp:layeredBundle basename="atg.commerce.csr.returns.WebAppResources">
    ...
    <a href="#"
      ...
      <dsp:input type="text"
        ...
        bean="AppeasementFormHandler.sortedRefundList[param:refundMethodIndex].amount"
...
<%-- @version $Id: //application/DCS-CSR-UI/version/11.2/src/web-apps/DCS-CSR-UI/panels/order/appeasements/displayAppeasementPmtCenterFrag.jsp#1 $$Change: 1179550 $--%>
