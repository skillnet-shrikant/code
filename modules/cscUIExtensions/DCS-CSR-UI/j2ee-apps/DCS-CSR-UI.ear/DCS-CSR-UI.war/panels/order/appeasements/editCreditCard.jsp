<%--
@version $Id: //application/DCS-CSR-UI/version/11.2/src/web-apps/DCS-CSR-UI/panels/order/appeasements/editCreditCard.jsp#1 $$Change: 1179550 $
...
<c:catch var="exception">
  <dsp:page xml="true">
    ...
    <dsp:getvalueof var="refundMethod" bean="AppeasementFormHandler.sortedRefundList[param:refundMethodIndex]" />
    ...
    <c:url var="successErrorURL" context="/${pgConfig.editAppeasementMethodPageFragment.servletContext}"
      value="${pgConfig.editAppeasementMethodPageFragment.URL}">
    ...
    <dsp:layeredBundle basename="atg.commerce.csr.order.WebAppResources">
      ...
      <dsp:form method="POST" action="#" id="${formId}" formid="${formId}">
        ...
        <c:if test="${!empty appeasement && !empty appeasement.originatingOrder}">
          <dsp:setvalue bean="UpdateCreditCardFormHandler.workingOrderId" value="${appeasement.originatingOrder.id }"/>
          <dsp:input type="hidden" value="${appeasement.originatingOrder.id }" bean="UpdateCreditCardFormHandler.workingOrderId" priority="10"/>
        </c:if>
