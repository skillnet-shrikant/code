<%--
 @version $Id: //application/DCS-CSR-UI/version/11.2/src/web-apps/DCS-CSR-UI/include/ticket/ticketGrid.jsp#1 $
...
dojo.provide("atg.commerce.csr.ticket");
atg.commerce.csr.ticket.refreshSearchResults${gridWidgetId} = function() {
  try {
  ...
  if (!_inst) {
    ...
    ${gridInstanceId} = atg.commerce.csr.ticket.setupResultsGrid${gridWidgetId}();
...
atg.commerce.csr.ticket.setupResultsGrid${gridWidgetId} = function () {
  var _inst = ${gridInstanceId};
  if (_inst) { console.debug("grid already set up"); return _inst;}

  var viewLink = "<a href=\"#\" class=\"blueU\" onclick=\"ticketHistoryViewTicket('orderRelatedTicketsViewTicketForm','theTicketId');return false;\">theTicketId</a>";
  var selectLink = "<a href=\"#\" class=\"blueU\" onclick=\"ticketHistoryWorkTicket('orderRelatedTicketsWorkTicketForm','theTicketId');return false;\"><fmt:message key='relatedTickets.workOnTicket'/></a>";
...
<div style="width:100%;">
  <div id="${gridWidgetId}"
       ...
       loadContent="atg.commerce.csr.ticket.refreshSearchResults${gridWidgetId}()">
  </div>
</div>
...
<%-- @version $Id: //application/DCS-CSR-UI/version/11.2/src/web-apps/DCS-CSR-UI/include/ticket/ticketGrid.jsp#1 $$Change: 946917 $--%>
