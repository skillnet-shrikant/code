			...
			<div class="row">
				<table>
					...
					<tbody>
						...
						<tr>
							<td>${fn:escapeXml(commerceItem.cardNumber)}</td>
							<td>Refund Gift Card</td>
							<td class="center">1</td>
							<td class="right">
								<dsp:droplet name="/com/mff/commerce/order/RefundableGiftcardAmount">
									<dsp:param name="paygroup" value="${commerceItem}" />
									...
									<dsp:oparam name="false">
										<csr:formatNumber value="0.0" type="currency" currencyCode="${currencyCode}"/>
									</dsp:oparam>
								</dsp:droplet>
							</td>
						</tr>
