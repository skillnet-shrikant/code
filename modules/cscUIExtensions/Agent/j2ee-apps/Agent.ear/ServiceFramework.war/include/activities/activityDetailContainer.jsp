...
@version $Id: //application/service-UI/version/11.2/framework/Agent/src/web-apps/ServiceFramework/include/activities/activityDetailContainer.jsp#1 $$Change: 946917 $
...
<dspel:page xml="true">
  <caf:outputXhtml targetId="${param.containerDivId}">
