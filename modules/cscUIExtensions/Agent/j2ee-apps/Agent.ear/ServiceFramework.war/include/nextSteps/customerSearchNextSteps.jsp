...
<dspel:page xml="true">
  <dspel:layeredBundle basename="atg.svc.agent.ticketing.TicketingResources">
    ...
    <dspel:getvalueof var="isActiveCustomerTransient" bean="/atg/userprofiling/ActiveCustomerProfile.transient"/>
    <dspel:getvalueof var="activeCustomerId" bean="/atg/userprofiling/ActiveCustomerProfile.repositoryId"/>
...
<!-- $Id: //application/service-UI/version/11.2/framework/Agent/src/web-apps/ServiceFramework/include/nextSteps/customerSearchNextSteps.jsp#1 $$Change: 946917 $$DateTime: 2015/01/26 17:26:27 $ -->
<%-- @version $Id: //application/service-UI/version/11.2/framework/Agent/src/web-apps/ServiceFramework/include/nextSteps/customerSearchNextSteps.jsp#1 $$Change: 946917 $--%>
