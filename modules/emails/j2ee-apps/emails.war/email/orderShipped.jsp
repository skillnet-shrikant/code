																...
																<table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
																	<tr style="padding:0;text-align:left;vertical-align:top">
																		<th style="Margin:0;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:center">
																			...
																			<!-- LOGO IMG -->
																			<img src="http://${siteHttpServerName}/resources/images/new_logo.png" width="250" style="-ms-interpolation-mode:bicubic;clear:both;display:block;max-width:100%;outline:0;text-decoration:none;width:250px;width:100%"/>
																	...
																	<tr style="padding:0;text-align:left;vertical-align:top">
																		<th style="Margin:0;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
																			...
																			<div class="message-text">
																				<h1 style="Margin:0;Margin-bottom:10px;color:inherit;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:22px;font-weight:400;line-height:1.3;margin:0;margin-bottom:15px;padding:0;text-align:left;word-wrap:normal">
																				...
																				<p style="Margin:0;Margin-bottom:15px;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;margin-bottom:15px;padding:0;text-align:left">
																					...
																					Thank you for your recent purchase at FleetFarm.com. Your order has shipped!
																				</p>

																				<p style="Margin:0;Margin-bottom:15px;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;margin-bottom:15px;padding:0;text-align:left">

																					You can track your package using the link below. Please note, it may take up to 48 hours for the tracking link to be made active by the carrier.
																				</p>

																				<p style="Margin:0 0 15px 0;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0 0 15px 0;padding:0;text-align:left">
																					<dsp:getvalueof var="prevTrackingNo" value=""/>
																					<dsp:droplet name="ForEach">
																						<dsp:param name="array" param="trackingNumberMap"/>
																						<dsp:oparam name="output">
																							<dsp:getvalueof var="trackingNo" param="element"/>
																							<c:if test="${ trackingNo ne prevTrackingNo}">
																								<dsp:getvalueof var="prevTrackingNo" param="element"/>

																								<a href="https://www.fedex.com/apps/fedextrack/?action=track&locale=en_US&cntry_code=us&tracknumbers=${trackingNo}" style="color:#fd6316!important;text-decoration:none"><span style="color:#fd6316!important"><font color="#fd6316">
																	...
																	<tr style="padding:0;text-align:left;vertical-align:top">
																		<th style="Margin:0;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;padding:0px 15px;padding-bottom:10px!important;text-align:left">
																			...
																			<dsp:droplet name="IsEmpty">
																				...
																				<dsp:oparam name="false">
																					<span class="label">Attention:</span><dsp:valueof param="shippingGroup.specialInstructions.instructions"/>
																				</dsp:oparam>
																			</dsp:droplet>
																	...
																	<tr style="padding:0;text-align:left;vertical-align:top">
																		<th style="Margin:0;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
																			...
																			<div class="product-container">
																				<dsp:droplet name="/com/mff/droplet/ShippedCommerceItemsCummulationDroplet">
																					<dsp:param name="order" param="order"/>
																					<dsp:param name="itemsToShip" param="itemsToShip"/>
																					<dsp:oparam name="output">
