                                    ...
                                    <th style="Margin:0;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
                                      <div class="message-text">
                                        ...
                                        <p style="Margin:0;Margin-bottom:15px;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;margin-bottom:15px;padding:0;text-align:left">
                                          ...
                                          Dear <dsp:valueof param="purchaserFirstName"/>&nbsp;<dsp:valueof param="purchaserLastName"/>,

                                        </p>
                                        <p style="Margin:0;Margin-bottom:15px;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;margin-bottom:15px;padding:0;text-align:left">

                                          Your request for an adjustment on order #<dsp:valueof param="order.orderNumber"/> has been processed. A credit in the amount of <dsp:valueof param="appeasement.appeasementAmount" converter="currency"/> has been applied. We sincerely apologize for any inconvenience.

                                        </p>
                                        <p style="Margin:0;Margin-bottom:15px;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;margin-bottom:15px;padding:0;text-align:left">

                                          If you have further questions regarding the information provided in this email, please contact Customer Service toll-free at 1-877-633-7456.
