																			...
																			<div class="message-text">
																				...
																				<p style="Margin:0;Margin-bottom:15px;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;margin-bottom:15px;padding:0;text-align:left">
																					...
																					placed by
																					 ...
																					 &nbsp;<dsp:valueof param="purchaserLastName"/>,
																				...
																				<dsp:valueof param="purchaserFirstName"/>
																					&nbsp;has listed you as the primary pickup person for this order. Instructions for pickup and store information are shown below.

																					<span class="red" style="color:#c00">Please pick up this order by store close on


																					<dsp:droplet name="/com/mff/droplet/BopisDeadlineDateDroplet">
																						<dsp:oparam name="output">
																							<dsp:valueof param="finalDate" date="EEEEE, MMMMM dd"/>.
																						</dsp:oparam>
																					</dsp:droplet>
																...
																<table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
																	<tr style="padding:0;text-align:left;vertical-align:top">
																		<th style="Margin:0;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
																			...
																			<a href="" style="Margin:0;color:#fd6316!important;font-family:Montserrat,Helvetica,Arial,sans-serif;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left;text-decoration:none">
