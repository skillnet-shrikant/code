<%--
	- File Name: passwordReset.jsp
	- Author(s): KnowledgePath Solutions
	- Copyright Notice:
	- Description: Email sent to user to notify password has been reset
	--%>

<dsp:page>
<dsp:getvalueof var="siteHttpServerName" bean="/mff/MFFEnvironment.siteHttpServerName" />
<dsp:getvalueof var="urlSafeUuid" param="resetToken" />
																		...
																		<th style="Margin:0;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
																			...
																			<div class="message-text">
																				...
																				<p style="Margin:0;Margin-bottom:15px;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;margin-bottom:15px;padding:0;text-align:left">
																					...
																					We received a request to reset the password on your FleetFarm.com account.

																					<a href="http://${siteHttpServerName}/sitewide/changePassword.jsp?urlSafeUuid=${urlSafeUuid}" style="Margin:0;color:#fd6316!important;font-family:Montserrat,Helvetica,Arial,sans-serif;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left;text-decoration:none"><span style="color:#fd6316!important"><font color="#fd6316">


																					Click here</font></span></a> to reset your password.
																				...
																				<p style="Margin:0;Margin-bottom:15px;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;margin-bottom:15px;padding:0;text-align:left">
																					...
																					This link will expire in 48 hours. If you ignore this message, your password won't be changed.

																				</p>

																				<p style="Margin:0;Margin-bottom:15px;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;margin-bottom:15px;padding:0;text-align:left">

																					If you have any questions about this email, like if you did not request a password reset or you're unsure why we prompted a reset at sign-in, please contact Customer Service toll-free at 1-877-633-7456.
																				</p>
