...
<dsp:param name="commerceItm" param="order.commerceItems[0]" />
<dsp:getvalueof var="siteHttpServerName" bean="/mff/MFFEnvironment.siteHttpServerName" />
<dsp:getvalueof param="reasonCode" var="reasonCode"/>
																		...
																		<th style="Margin:0;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
																			...
																			<div class="message-text">
																				...
																				<dsp:droplet name="Switch">
																					<dsp:param name="value" param="cancelType"/>
																					<dsp:oparam name="full">
																							<!-- Condition 1: NO PICKUP - canceled within time frame -->
																							<p style="Margin:0;Margin-bottom:15px;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;margin-bottom:15px;padding:0;text-align:left">
																								<dsp:droplet name="Switch">
																									<dsp:param name="value" value="${reasonCode}"/>
																									<dsp:oparam name="customerCancelled">
																										At your request, we have cancelled order #<dsp:valueof param="order.orderNumber"/>.
																									</dsp:oparam>
																									<dsp:oparam name="cannotVerifyPayment">
																										Unfortunately, because we were unable to verify the form of payment provided for order #<dsp:valueof param="order.orderNumber"/>, we cannot complete your order.
																									</dsp:oparam>
																									<dsp:oparam name="default">
																										Unfortunately, despite our best efforts, we are unable to fulfill order #<dsp:valueof param="order.orderNumber"/>.
																									</dsp:oparam>
																								</dsp:droplet>
																							...
																							<p style="Margin:0;Margin-bottom:15px;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;margin-bottom:15px;padding:0;text-align:left">
																								...
																								<dsp:droplet name="Switch">
																									<dsp:param name="value" value="${reasonCode}"/>
																									<dsp:oparam name="customerCancelled">
																									 	As we don't charge you until your order has been picked up, you will not be charged for this order.
																									 </dsp:oparam>
																									<dsp:oparam name="cannotVerifyPayment">
																										<!-- Dont show anything  -->
																									</dsp:oparam>
																									<dsp:oparam name="default">
																										We apologize for any inconvenience this may have caused. As we don't charge you until your order has been picked up, you will not be charged for this order.
																										<!--  We have cancelled your order and you will not be charged. -->
																									</dsp:oparam>
																								</dsp:droplet>
																							...
																							<p style="Margin:0;Margin-bottom:15px;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;margin-bottom:15px;padding:0;text-align:left">
																								<dsp:droplet name="Switch">
																									...
																									<dsp:oparam name="default">
																										If you would like to place a reorder or have any questions regarding the information provided in this email, please contact Customer Service toll-free at 1-877-633-7456.
																									</dsp:oparam>
																								</dsp:droplet>
																					...
																					<dsp:oparam name="partial">
																							<!-- Condition 2: NO INVENTORY canceled by store -->
																							<p style="Margin:0;Margin-bottom:15px;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;margin-bottom:15px;padding:0;text-align:left">
																								<dsp:droplet name="Switch">
																									<dsp:param name="value" value="${reasonCode}"/>
																									<dsp:oparam name="customerCancelled">
																									 	At your request, we have cancelled the below items from order #<dsp:valueof param="order.orderNumber"/>.
																									</dsp:oparam>
																									<dsp:oparam name="cannotVerifyPayment">
																										Unfortunately, because we were unable to verify the form of payment provided for order #<dsp:valueof param="order.orderNumber"/>, we cannot complete your order.
																									</dsp:oparam>
																									<dsp:oparam name="default">
																										Unfortunately, despite our best efforts, we are unable to fulfill the below items from order #<dsp:valueof param="order.orderNumber"/>
																										<!--  We regret to inform you that we are unable to fulfill your recent Fleet Farm order #<dsp:valueof param="order.orderNumber"/> at <dsp:valueof param="store.name"/> location. We sincerely apologize for any inconvenience. -->
																									</dsp:oparam>
																								</dsp:droplet>
																							...
																							<p style="Margin:0;Margin-bottom:15px;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;margin-bottom:15px;padding:0;text-align:left">
																								<dsp:droplet name="Switch">
																									<dsp:param name="value" value="${reasonCode}"/>
																									<dsp:oparam name="customerCancelled">
																									 	As we don't charge you until your order has been picked up, you will not be charged for these items.
																									 	You will receive another email when the remaining item(s) on your order are available for pickup at your selected location.
																									</dsp:oparam>
																									<dsp:oparam name="cannotVerifyPayment">
																										<!-- Dont show anything  -->
																									</dsp:oparam>
																									<dsp:oparam name="default">
																										We apologize for any inconvenience this may have caused. As we don't charge you until your order has been picked up, you will not be charged for these items.
																										You will receive another email when the remaining item(s) on your order are available for pickup at your selected location.
																										<!--  We have cancelled your order and you will not be charged. -->
																									</dsp:oparam>
																								</dsp:droplet>
																							...
																							<p style="Margin:0;Margin-bottom:15px;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;margin-bottom:15px;padding:0;text-align:left">
																								...
																								<dsp:droplet name="Switch">
																									...
																									<dsp:oparam name="default">
																										If you have any questions regarding the information provided in this email, please contact your store pick-up location listed below.
																										<!--  If you would like us to check product availability at a different store or have any questions regarding the information provided in this email, please contact Customer Service toll-free at 1-877-633-7456.-->
																									</dsp:oparam>
																								</dsp:droplet>
																...
																<table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
																	<tr style="padding:0;text-align:left;vertical-align:top">
																		<th style="Margin:0;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:700;line-height:1;margin:0;padding:0px 15px;text-align:left">
																			...
																			Purchaser: <span style="font-weight:400">
																...
																<table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
																	<tr style="padding:0;text-align:left;vertical-align:top">
																		<th style="Margin:0;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:700;line-height:1;margin:0;padding:0px 15px;text-align:left">
																			...
																			Alternate Pickup Person: <span style="font-weight:400">
																...
																<table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
																	<tr style="padding:0;text-align:left;vertical-align:top">
																		<th style="Margin:0;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:700;line-height:1;margin:0;padding:0px 15px;text-align:left">
																			...
																			Shipping via: <span class="orange" style="color:#fd6316;font-weight:400">Pickup In Store</span>
																			...
																			<div class="product-container">
																				...
																				<dsp:droplet name="ForEach">
																					...
																					<dsp:oparam name="output">
																						...
																						<dsp:getvalueof var="ciState" param="commerceItem.stateAsString"/>

																						<c:if test="${ciState ne 'CANCELLED'}">
																...
																<div class="product-container">
																	...
																	<dsp:droplet name="ForEach">
																		...
																		<dsp:oparam name="output">
																			...
																			<dsp:getvalueof var="ciState" param="commerceItem.stateAsString"/>
																			<c:if test="${ciState eq 'CANCELLED'}">
																							...
																							<dsp:getvalueof var="discountValueFlag" param="order.priceInfo.discountAmount" />
																								<c:if test="${discountValueFlag gt 0}">
																									<tr class="total-row savings" style="padding:0;text-align:left;vertical-align:top">
																										...
																										<td class="total-amount" min-width="150" style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;border-collapse:collapse!important;color:#c00;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:700;hyphens:auto;line-height:1.3;margin:0 10px 5px 0;padding:2px 10px 2px 0!important;text-align:right;vertical-align:top;width:100%;white-space:nowrap">
																...
																<table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
																	<tr style="padding:0;text-align:left;vertical-align:top">
																		<th style="Margin:0;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
																			...
																			<a href="https://${siteHttpServerName}/static/bopis-faq" style="Margin:0;color:#fd6316!important;font-family:Montserrat,Helvetica,Arial,sans-serif;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left;text-decoration:none"><span style="color:#fd6316!important"><font color="#fd6316">
