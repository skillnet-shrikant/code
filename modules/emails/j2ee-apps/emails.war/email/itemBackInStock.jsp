																		...
																		<th style="Margin:0;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
																			...
																			<div class="message-text">
																				...
																				<p style="Margin:0;Margin-bottom:15px;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;margin-bottom:15px;padding:0;text-align:left">
																					...
																					Dear <dsp:valueof param="firstName"/>,
																				...
																				<p style="Margin:0;Margin-bottom:15px;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;margin-bottom:15px;padding:0;text-align:left">
																					...
																					The
																					<b><dsp:valueof param="product.description"/></b>
																					 you were interested in is now back in stock.
																...
																<table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
																	<tr style="padding:0;text-align:left;vertical-align:top">
																		<th style="Margin:0;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
																			...
																			<div class="shared-product-container">
																				<table class="row" style="border-collapse:collapse;border-spacing:0;display:table;padding:0;position:relative;text-align:left;vertical-align:top;width:100%">
																					<tbody>
																						<tr style="padding:0;text-align:left;vertical-align:top">
																							<th class="small-12 large-4 columns first" style="Margin:0 auto;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0 auto;padding:0;padding-bottom:16px;padding-left:0!important;padding-right:0!important;text-align:left;width:33.33333%">
																								<table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
																									<tr style="padding:0;text-align:left;vertical-align:top">
																										<th style="Margin:0;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
																											...
																											<!-- product image -->
																												<div class="product-image">
																													...
																													<img src='https://${siteHttpServerName}/images/product/<dsp:valueof param="productId"/>/m/1.jpg' width="200" style="-ms-interpolation-mode:bicubic;clear:both;display:block;max-width:100%;outline:0;text-decoration:none;width:200px;">
																										...
																										<tr style="padding:0;text-align:left;vertical-align:top">
																											<th style="Margin:0;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;mso-line-height-rule:exactly;line-height:1.3;margin:0;padding:0 10px;text-align:left">
																												...
																												<div class="product-details">
																													...
																													<div class="item-subdetail" style="font-size:13px;font-weight:700;line-height:1.4rem">
																														...
																														<span style="font-weight:400">
																															...
																															<dsp:valueof param="skuId"/>

																														</span>

																													</div>

																													<div class="item-price" style="color:#fd6316;font-size:1rem">
																												...
																												<dsp:droplet name="/atg/dynamo/droplet/IsEmpty">
																													<dsp:param name="value" param="product.description"/>
																													<dsp:oparam name="false">
																														<dsp:getvalueof var="displayString" param="product.description" />
																													</dsp:oparam>
																													<dsp:oparam name="true">
																														<dsp:getvalueof var="displayString" param="productId" />
																													</dsp:oparam>
																												</dsp:droplet>
																												<!-- view item button -->
