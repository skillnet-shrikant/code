																			...
																			<div class="message-text">
																				...
																				<dsp:droplet name="Switch">
																					...
																					<dsp:oparam name="full">
																						<!-- Condition 1: Canceled (FULL order) -->
																						...
																						<p style="Margin:0;Margin-bottom:15px;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;margin-bottom:15px;padding:0;text-align:left">
																							<dsp:droplet name="Switch">
																								<dsp:param name="value" value="${reasonCode}"/>
																								<dsp:oparam name="customerCancelled">
																								 	As we don't charge you until your order has been shipped, you will not be charged for this order.
																								</dsp:oparam>
																								<dsp:oparam name="cannotVerifyPayment">
																									<!-- Dont show anything  -->
																								</dsp:oparam>
																								<dsp:oparam name="default">
																									We apologize for any inconvenience this may have caused. As we don't charge you until your order has been shipped, you will not be charged for this order.
																					...
																					<!-- Condition 2: Canceled (PARTIAL order) -->
																					<p style="Margin:0;Margin-bottom:15px;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;margin-bottom:15px;padding:0;text-align:left">
																						<dsp:droplet name="Switch">
																							<dsp:param name="value" value="${reasonCode}"/>
																							<dsp:oparam name="customerCancelled">
																							...
																							<dsp:oparam name="default">
																								...
																								<!--  Item(s) from your recent Fleet Farm order #<dsp:valueof param="order.orderNumber"/> have been cancelled, and your order has been updated. -->
																							</dsp:oparam>
																						</dsp:droplet>
																					...
																					<p style="Margin:0;Margin-bottom:15px;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;margin-bottom:15px;padding:0;text-align:left">
																						<dsp:droplet name="Switch">
																							...
																							<dsp:oparam name="customerCancelled">
																							 	As we don't charge you until your order has been shipped, you will not be charged for this order.
																							 	You will receive a shipment notification when the remaining item(s) on your order have been shipped.
																							</dsp:oparam>
																							<dsp:oparam name="cannotVerifyPayment">
																								<!-- Dont show anything  -->
																							</dsp:oparam>
																							<dsp:oparam name="default">
																								We apologize for any inconvenience this may have caused. As we don't charge you until your order has been shipped, you will not be charged for these items.
																								You will receive a shipment notification when the remaining item(s) on your order have been shipped.
																								<!--  You will not be charged for these item(s). Refer to the modified order details provided below.-->
																							</dsp:oparam>
																						</dsp:droplet>
																					</p>
																...
																<table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
																	<tr style="padding:0;text-align:left;vertical-align:top">
																		<th style="Margin:0;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:700;line-height:1;margin:0;padding:0px 15px;text-align:left">
																			...
																			Shipping via:
																			<span class="orange" style="color:#fd6316;font-weight:400">
																	...
																	<tr style="padding:0;text-align:left;vertical-align:top">
																		<th style="Margin:0;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
																			...
																			<div class="product-container">
																				...
																				<!-- order item -->
																				<dsp:droplet name="/com/mff/droplet/CancelCommerceItemsCummulationDroplet">
																		...
																		<th style="Margin:0;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
																			...
																			<div class="product-container">
																				...
																				<dsp:droplet name="/com/mff/droplet/CancelCommerceItemsCummulationDroplet">
																					...
																					<dsp:droplet name="ForEach">
																						<dsp:param name="array" param="cancelledItemSet"/>
																						<dsp:param name="elementName" value="commerceItemVO"/>
																						<dsp:oparam name="output">
																...
																<table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
																	<tr style="padding:0;text-align:left;vertical-align:top">
																		<th style="Margin:0;color:#0a0a0a;font-family:Montserrat,Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
																			...
																			<!-- salutations message -->
																			If you have any questions, please contact Customer Service toll-free at 1-877-633-7456.
