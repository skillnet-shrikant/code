<dsp:page>
	...
	<c:forEach var="elementSecondaryContent" items="${contentItem.TwoColumnSecondaryContent}">
	...
	<c:forEach var="element" items="${contentItem.OneColumnMainContent}">
	...
	<section class="two-column-container">
		...
		<%-- search results info --%>
		<c:forEach var="mainContent" items="${contentItem.TwoColumnMainContent}">
			<c:choose>
		...
		<div class="two-column-right">
			<c:forEach var="elementMainContent" items="${contentItem.TwoColumnMainContent}">
