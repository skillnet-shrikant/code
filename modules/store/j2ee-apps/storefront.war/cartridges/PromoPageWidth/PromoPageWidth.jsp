			...
			<section id="${contentItem.anchorTag}">
				<div class="section-row ${mobileHideClass} ${desktopHideClass}" ${customStyle}>
					<div class="section-content">
						<div class="promo-page-width" data-promotion='${promoName}' data-promotionname='${promoName}' data-promotionposition="slot" data-promotionlink="${contentItem.imageButtonHref1}">
