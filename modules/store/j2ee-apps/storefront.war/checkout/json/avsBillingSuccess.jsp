...
<dsp:page>
	...
	<dsp:getvalueof var="displayAvsModal" bean="PaymentGroupFormHandler.displayAvsModal" />
	<dsp:getvalueof var="suggestedAddress" bean="CheckoutManager.billingAvsVO.suggestedAddress" />
	<dsp:getvalueof var="enteredAddress" bean="CheckoutManager.billingAvsVO.enteredAddress" />
	...
	<json:object>
		...
		<c:choose>
			...
			<c:otherwise>
				...
				<json:property name="submitId">#payment-submit</json:property>
		...
		<c:if test="${empty suggestedAddress}">
