...
- Author(s): jjensen
- Copyright Notice:
- Description: Creates a json message for shipping method success
- Parameters:
--%>
...
<dsp:page>
	...
	<json:object>
		...
		<json:property name="shipMethod"><dsp:valueof param="order.shippingGroups[0].shippingMethod"/></json:property>
