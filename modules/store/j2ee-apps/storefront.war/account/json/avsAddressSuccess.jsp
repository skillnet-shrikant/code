<%--
- File Name: avsAddressSuccess.jsp
- Author(s):
- Copyright Notice:
- Description: Creates a json message for billing address avs modal
- Parameters:
--%>
...
<dsp:page>
	...
	<dsp:droplet name="/atg/dynamo/droplet/ProtocolChange">
		<dsp:param name="inUrl" value="${contextPath}/account/addressBook.jsp"/>
