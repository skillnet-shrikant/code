<dsp:page>
	...
	<div class="field-group">
		...
		<dsp:input type="submit" bean="StoreLocatorFormHandler.findStores" id="bopis-search-submit-modal" name="bopis-search-submit-modal" class="button primary" value="Find Stores" />
