...
public class AciException extends ContainerException {
	...
	public AciException(String pKey) {
		mKey = pKey;
	}
	...
	public AciException(String pKey, boolean pParamsAsKeys, Object... pParams) {
		mKey = pKey;
		mParams = pParams;
	...
	public AciException(Throwable pSourceException) {
		super(pSourceException);
	}

	public AciException(String pStr, Throwable pSourceException) {
