 ...
 */
public class GoogleFeedCreatorScheduler extends SingletonSchedulableService {
	...
	public void doTask(){
		...
		if (isLoggingInfo()){
			...
			GoogleFeedCreator task = getTask();
	 ...
	 */
	public GoogleFeedCreator getTask() {
		return task;
	}
	 ...
	 */
	public void setTask(GoogleFeedCreator task) {
		this.task = task;
	}
	...
	private GoogleFeedCreator task;
