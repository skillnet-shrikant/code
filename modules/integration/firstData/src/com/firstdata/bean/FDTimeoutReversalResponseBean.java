...
public class FDTimeoutReversalResponseBean implements FirstDataBean  {

  
  @FirstDataField(key="11")
  private String systemTraceNumber;
  
  @FirstDataField(key="15")
  private String terminalTransactionNumber;
  ...
  public String getTerminalTransactionNumber() {
    return terminalTransactionNumber;
  }

  public void setTerminalTransactionNumber(String pTerminalTransactionNumber) {
    terminalTransactionNumber = pTerminalTransactionNumber;
  }
