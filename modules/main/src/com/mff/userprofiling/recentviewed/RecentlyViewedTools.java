...
public class RecentlyViewedTools extends GenericService {
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.2/EStore/src/atg/projects/store/profile/recentlyviewed/RecentlyViewedTools.java#3 $$Change: 1174358 $";
  ...
  //---------------------------------------------
  private MFFProfileTools mProfileTools = null;

  /**
   * @return A MFFProfileTools instance.
   */
  ...
  /**
   * @param pProfileTools A MFFProfileTools instance.
   */
    ...
    if(recentlyViewedProducts != null) {
      ...
      if (recentlyViewedProductsSize > 0) {
        ...
        String recentlyViewedProductSiteIdPropertyName = 
          ((MFFPropertyManager) getProfileTools().getPropertyManager()).getSiteIdPropertyName();          
  ...
  public boolean removeNonExistentProducts(List<RepositoryItem>pRecentlyViewed, RepositoryItem pProfile) 
    ...
    if (pRecentlyViewed != null && pRecentlyViewed.size() > 0) {
      ...
      String recentlyViewedProductProductName = 
        ((MFFPropertyManager) getProfileTools().getPropertyManager()).getProductPropertyName();
  ...
  public MutableRepositoryItem createRecentlyViewedProduct(RepositoryItem pProduct, RepositoryItem pProfile, String pSiteId) 
    ...
    String recentlyViewedProductItemDescriptorName = 
      ((MFFPropertyManager) getProfileTools().getPropertyManager()).getRecentlyViewedProductItemDescriptorName();
    String recentlyViewedProductProductName = 
      ((MFFPropertyManager) getProfileTools().getPropertyManager()).getProductPropertyName();
    String recentlyViewedProductSiteIdName = 
      ((MFFPropertyManager) getProfileTools().getPropertyManager()).getSiteIdPropertyName();
    String recentlyViewedProductTimeStampName = 
      ((MFFPropertyManager) getProfileTools().getPropertyManager()).getTimeStampPropertyName();
  ...
  public List<RepositoryItem> getProductsForUpdate(RepositoryItem pProfile) throws RepositoryException {    
    ...
    String recentlyViewedProductsPropertyName = 
      ((MFFPropertyManager) getProfileTools().getPropertyManager()).getRecentlyViewedProductsPropertyName();
